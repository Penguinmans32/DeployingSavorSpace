      ...
      <div className="recipe-content">
        <div className="recipe-meta">
          <span className="recipe-cuisine">
            <img src="/DeployingSavorSpace/images/dish.png" alt="Cuisine" />
            Filipino Dish
          </span>
          <span className="recipe-course">
            <img src="/DeployingSavorSpace/images/course.png" alt="Course" />
            Main Course
          </span>
        </div>
...
const LandingPage = () => {
  ...
  const communityCards = [
    {
      image: "/DeployingSavorSpace/images/graham-card.jpg",
      title: "Mango Graham",
    ...
    {
      image: "/DeployingSavorSpace/images/bicolexpress-card.avif",
      title: "Bicol Express",
    ...
    {
      image: "/DeployingSavorSpace/images/crispypata-card.jpg",
      title: "Crispy Pata",
    ...
    {
      image: "/DeployingSavorSpace/images/sisig-card.jpg",
      title: "Sisig",
    ...
    {
      image: "/DeployingSavorSpace/images/maja-card.jpg",
      title: "Maja Blanca",
  ...
  const chefCard = [
      {
        image: "/DeployingSavorSpace/images/chef1.png",
        name: "Lily Anderson",
      ...
      {
        image: "/DeployingSavorSpace/DeployingSavorSpace/images/chef2.png",
        name: "Emma Nguyen",
      ...
      {
        image: "/DeployingSavorSpace/images/chef3.png",
        name: "Lucas Martinez",
  ...
  const teamCard = [
    {
      image: "/DeployingSavorSpace/images/omen.png",
      name: "Jared Karl Omen",
      title: "Full-Stack Developer",
    },

    {
      image: "/DeployingSavorSpace/images/capuras.png",
    ...
    {
      image: "/DeployingSavorSpace/images/chavez.png",
      name: "Jes Emanuel Chavez",
      title: "Full-Stack Developer",
    },
    
    {
      image: "/DeployingSavorSpace/images/gadiane.png",
      name: "John Karl Gadiane",
      title: "Full-Stack Developer",
    },

    {
      image: "/DeployingSavorSpace/images/pejana.png",
      ...
      <footer className="footer">
        <div className="footer-content">
          <div className="footer-logo">
            <img src="/DeployingSavorSpace/images/savorspaceLogo.png" alt="SavorSpace Logo" className="footer-logo-img" />
