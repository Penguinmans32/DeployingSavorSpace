...
const RecipeComments = ({ recipeId, isVisible}) => {
    ...
    const getImageURL = (imageURL) => {
      if(!imageURL) return "/DeployingSavorSpace/images/defaultProfiles.png";
    ...
    const fetchComments = async () => {
      ...
      try {
          ...
          const formattedComments = Array.isArray(data) ? data.map(comment => ({
              ...
              userImageURL: comment.userImageURL || '/DeployingSavorSpace/images/defaultProfiles.png'
          })) : [];
        ...
        <div className="community-user">  
          <img
            src={recipe.user?.imageURL
              ...
              : "/DeployingSavorSpace/images/defaultProfiles.png"
            }
